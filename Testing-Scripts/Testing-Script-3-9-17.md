...
_user is likely to end up on the legacy site for this task. if so, ask them to complete another task starting from there._ - Okay, now imagine that you want to look up some data specifically about Hillary Clinton. Specifically, you want to know how much money she raised from everyday people. What would you do?   
